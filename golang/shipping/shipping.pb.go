...
type CreateShippingResponse struct {
	...
	DeliveryDays  int32                  `protobuf:"varint,2,opt,name=delivery_days,json=deliveryDays,proto3" json:"delivery_days,omitempty"` // Prazo em dias
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	"shippingId\x12#\n" +
	"\rdelivery_days\x18\x02 \x01(\x05R\fdeliveryDays2E\n" +
	"\bShipping\x129\n" +
	"\x06Create\x12\x16.CreateShippingRequest\x1a\x17.CreateShippingResponseB>Z<github.com/l-e-t-i-c-i-a/microservices-proto/golang/shippingb\x06proto3"
