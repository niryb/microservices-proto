...
const file_order_order_proto_rawDesc = "" +
	...
	"\border_id\x18\x01 \x01(\x05R\aorderId2O\n" +
	"\fOrderService\x12?\n" +
	"\x06Create\x12\x19.order.CreateOrderRequest\x1a\x1a.order.CreateOrderResponseB3Z1github.com/niryb/microservices-proto/golang/orderb\x06proto3"
...
var file_order_order_proto_depIdxs = []int32{
	...
	0, // 1: order.OrderService.Create:input_type -> order.CreateOrderRequest
	2, // 2: order.OrderService.Create:output_type -> order.CreateOrderResponse
